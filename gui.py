...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.graph_list_label = ctk.CTkLabel(self.sidebar_frame, text="Available Graphs:", anchor="w")
    ...
    def setup_info_tab(self):
        ...
        self.stats_label = ctk.CTkLabel(self.info_tab, text="No graph loaded", justify="left", font=ctk.CTkFont(size=14))
    ...
    def setup_viz_tab(self):
        ...
        self.fig.patch.set_facecolor('#2b2b2b') # CTK dark background color
    ...
    def load_graph_list(self):
        ...
        for f in files:
            btn = ctk.CTkButton(self.graph_listbox, text=f, fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), anchor="w", command=lambda x=f: self.select_graph(x))
    ...
    def draw_graph_in_canvas(self):
        ...
        # Style based on appearance mode
        is_dark = ctk.get_appearance_mode() == "Dark"
        bg_color = '#2b2b2b' if is_dark else '#dbdbdb'
        text_color = 'white' if is_dark else 'black'
        node_color = '#1f6aa5' # Blue theme
        ...
        nx.draw_networkx_edges(G, pos, ax=self.ax, edge_color=text_color, arrows=True, arrowsize=20, connectionstyle='arc3,rad=0.1')
        
        edge_labels = nx.get_edge_attributes(G, 'weight')
        nx.draw_networkx_edge_labels(G, pos, edge_labels=edge_labels, ax=self.ax, font_color=text_color, font_size=8, bbox=dict(facecolor=bg_color, edgecolor='none', alpha=0.7))
